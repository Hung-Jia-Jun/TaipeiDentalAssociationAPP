...
import { Dimensions,KeyboardAvoidingView,TouchableWithoutFeedback,Keyboard,StyleSheet,Image,TouchableOpacity,Button,FlatList,ImageBackground,TextInput,Text, View } from "react-native";
...
class Message extends Component {
    ...
    componentDidMount()
    {
        try
        {
            var ToggleBtnJs = JSON.parse(this.props.navigation.getParam('ToggleBtn'));
    ...
    appendMember()
    {
        ...
        this.props.navigation.push('InviteGroupChat',{ToggleBtn : JSON.stringify(this.state.ToggleBtn),GroupUsers:[],LastPage:"CreateChatRoom"});
    }
  render() {
