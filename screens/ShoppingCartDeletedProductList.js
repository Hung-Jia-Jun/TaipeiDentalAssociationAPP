            ...
            <ImageBackground source={image} style={styles.image}>
                ...
                <View style={{flex: 0.08, flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity style={styles.button,{
                        ...
                        marginLeft: 5,
                        marginTop: 0,
                    }} onPress={()=>this.props.navigation.push('ShoppingCartDoneProductList')}>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.button,{
                        borderWidth: 1,
                        height: 50,
                        ...
                        marginLeft: 5,
                        marginTop: 0,
                    }} onPress={()=>this.props.navigation.push('ShoppingCartDeletedProductList')}>
                    </TouchableOpacity>
                </View>
                <View style={{flex: 0.8, flexDirection: 'row'}}>
                     <TouchableOpacity style={styles.button,{
                        ...
                        borderWidth:1,
                        borderColor:'black',
                    }} onPress={()=>this.props.navigation.push('ShoppingCartDeleteProductConfirm')}>
                    </TouchableOpacity> 
                </View>
